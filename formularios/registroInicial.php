    ...
    <main>
        <div id="muestra">
            ...
            <?php
                ...
                function mostrarRegistros($connection2, $inicial) {
                    $consulta = "SELECT * FROM inscripciones WHERE nombre LIKE '" . mysqli_real_escape_string($connection2, $inicial) . "%'";
                ...
                if (mysqli_num_rows($db_exists_result) == 0) {
                    ...
                    $registros = mostrarRegistros($connection2, $inicial);
                }
